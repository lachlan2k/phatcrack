...
wget https://github.com/lachlan2k/phatcrack/releases/download/v0.6.0/docker-compose.yml
...
# Or, you can download from https://github.com/lachlan2k/phatcrack/releases/download/v0.6.0/phatcrack-agent

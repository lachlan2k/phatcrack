...
wget https://github.com/lachlan2k/phatcrack/releases/download/v0.1.0/docker-compose.yml
...
# Or, you can download from https://github.com/lachlan2k/phatcrack/releases/download/v0.1.0/phatcrack-agent

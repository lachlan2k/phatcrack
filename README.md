...
wget https://github.com/lachlan2k/phatcrack/releases/download/v0.3.0/docker-compose.yml
...
# Or, you can download from https://github.com/lachlan2k/phatcrack/releases/download/v0.3.0/phatcrack-agent
